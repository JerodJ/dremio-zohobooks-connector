...
@SourceType(value = "ZohoBooksARP", label = "ZohoBooks",uiConfig = "zohobooks-layout.json")
public class ZohoBooksConf extends AbstractArpConf<ZohoBooksConf> {
  private static final String ARP_FILENAME = "arp/implementation/zohobooks-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.zohobooks.ZohoBooksDriver";
